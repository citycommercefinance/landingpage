...
tags: "standby letter of credit, bank guarantee, due diligence, trade finance fraud, UAE"
---
# How to Verify an SBLC or Bank Guarantee Provider Before You Pay a Dirham
...
If the instrument is to be issued by a UAE bank, search the Central Bank of the UAE's licensing register directly at [centralbank.ae/en/licensing](https://www.centralbank.ae/en/licensing/). It lists licensed banks, finance companies, exchange houses and payment providers, searchable by name.
...
- **DFSA Public Register** — [dfsa.ae/public-register](https://www.dfsa.ae/public-register) for DIFC firms
- **ADGM FSRA Public Register** — [adgm.com/public-registers/fsra](https://www.adgm.com/public-registers/fsra) for Abu Dhabi Global Market
- **Invest in Dubai licence search** — [app.invest.dubai.ae/search-license](https://app.invest.dubai.ae/search-license) to confirm a Dubai mainland trade licence exists and matches the name given
...
- **DFSA Alerts** — [dfsa.ae/alerts](https://www.dfsa.ae/alerts)
- **ADGM FSRA Regulatory Alerts** — [adgm.com](https://www.adgm.com/operating-in-adgm/additional-obligations-of-financial-services-entities/enforcement/regulatory-alerts)
- **SCA warnings** — [uaecma.gov.ae/en/open-data/warnings.aspx](https://www.uaecma.gov.ae/en/open-data/warnings.aspx)
- **UK FCA Warning List** — [fca.org.uk](https://www.fca.org.uk/consumers/warning-list-unauthorised-firms), which matters because so many of these entities claim a London address
...
If you are still working out which instrument your deal actually needs, start with our guide to [letters of credit, bank guarantees and standby LCs](/insights/letter-of-credit-vs-bank-guarantee-vs-sblc-uae).
...
**Does an MT799 prove an instrument exists?**
No. MT799's official SWIFT designation is "Free Format Message." It is unstructured text and creates no payment undertaking. A demand guarantee or standby is issued by MT760; a documentary credit by MT700.

**A provider says it is DIFC registered. Is it regulated?**
Not necessarily, and usually not. The DFSA states that incorporation in the DIFC does not confer the ability to provide financial services, and that over 85% of DIFC-incorporated companies hold no financial services licence. Check the DFSA Public Register for authorisation, which is a separate thing from registration.

**Can the ICC confirm whether my instrument is genuine?**
No. The ICC publishes the rulebooks that instruments can be made subject to. It does not register, approve, endorse or verify individual instruments, and it has stated it never published rules on NCND agreements. Any document claiming ICC registration of an instrument is misrepresenting the ICC.

**How do I check whether a UAE company is licensed?**
For a bank or finance company, search the CBUAE licensing register. For a DIFC firm, the DFSA Public Register. For ADGM, the FSRA Public Register. For a Dubai mainland trade licence, the Invest in Dubai licence search. Then check the name and near-matches against the DFSA, FSRA, SCA and UK FCA warning lists.

**I have already paid a provider and received nothing. What now?**
Preserve everything — the term sheet, all correspondence, wire confirmations, and the entity and individual names used. Report to the police in the emirate where you transacted, and to your own bank's fraud team, which may be able to attempt recall on recent transfers. If the counterparty claimed regulation by the DFSA, FSRA or SCA, report to that regulator, as false claims of regulated status are themselves actionable. Then take independent legal advice before any further payment — the most common second loss is a "recovery fee" paid to get the first one back.
...
- ICC Financial Investigation Bureau — [FIB warns of fake bank guarantees](https://icc-ccs.org/fib-warns-of-fake-bank-guarantees/)
- ICC Commercial Crime Services — [CCS foils multi-billion dollar internet banking fraud](https://iccwbo.org/news-publications/news/ccs-foils-multi-billion-dollar-internet-banking-fraud/)
- US Federal Reserve — [SR 02-13: Fraudulent Financial Instruments](https://www.federalreserve.gov/boarddocs/srletters/2002/sr0213.htm)
- US Federal Reserve — [Prime Bank Investment Scheme Advisory](https://www.federalreserve.gov/frrs/guidance/prime-bank-investment-scheme-advisory.htm)
- US Department of Justice, EDVA — [Fraudsters Sentenced in Standby Letters of Credit Scheme](https://www.justice.gov/usao-edva/pr/fraudsters-sentenced-standby-letters-credit-scheme-1)
- US SEC — [Prime Bank investor alert](https://www.investor.gov/introduction-investing/general-resources/news-alerts/alerts-bulletins/investor-alerts/investor-57)
- US interagency advisory (Federal Reserve, FDIC, OCC, OTS, NCUA), 21 October 1993 — [reproduced by the Federal Reserve Bank of New York](https://www.newyorkfed.org/banking/circulars/10858.html)
- DFSA — ["Incorporated is not the same as Authorised or Licensed" explainer, October 2023](https://www.dfsa.ae/) and [Alerts](https://www.dfsa.ae/alerts)
- Central Bank of the UAE — [Licensing register](https://www.centralbank.ae/en/licensing/)
- UAE Government portal — [Running a business in a free zone](https://u.ae/en/information-and-services/business/doing-business-in-free-zones/running-a-business-in-a-free-zone-)
- SWIFT — [Category 7 Standards: Documentary Credits and Guarantees](https://www.swift.com/sites/default/files/files/swift_cat7_advanceinformation_feb2022.pdf)
